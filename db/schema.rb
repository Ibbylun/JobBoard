...
ActiveRecord::Schema.define(version: 20160910040227) do
  ...
  create_table "job_listing_skills", force: :cascade do |t|
    t.integer  "job_listing_id"
    t.integer  "skill_id"
    t.datetime "created_at",     null: false
    t.datetime "updated_at",     null: false
    t.index ["job_listing_id"], name: "index_job_listing_skills_on_job_listing_id"
    t.index ["skill_id"], name: "index_job_listing_skills_on_skill_id"
  end
